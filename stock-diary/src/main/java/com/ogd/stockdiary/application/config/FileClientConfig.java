 ...
 *
 * <p>
 * FileClientPort 구현체를 Bean으로 등록합니다.
 *
 * <p>
 * <b>AWS S3로 전환시:</b> MinioFileClientAdapter 대신 S3FileClientAdapter를 주입하도록
 * 변경합니다.
 */
@Configuration
public class FileClientConfig {
     ...
     *
     * <p>
     * 현재는 MinioFileClientAdapter를 사용하지만, AWS S3로 전환시 구현체만 교체하면 됩니다.
     *
     * @param minioAdapter
     *            MinIO 어댑터 (Spring이 자동으로 주입)
